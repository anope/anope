...
static void my_add_languages(void)
{
   ...
   char *langtable_de[] = {
    ...
    char *langtable_fr[] = {
        ...
        /* LNG_CHAN_HELP_ENFORCE */
        "Renforce divers modes et options de salons. Le paramиtre \037canal\037\n"
            "indique pour quel canal renforcer les options ou modes.\n"
            "Le paramиtre \037option\037 indique quels modes et options\n"
            "renforcer, et peut кtre SET, SECUREOPS, RESTRICTED, MODES,\n"
            "ou +R. Par dйfaut, il est SET.\n"
            " \n"
            "Si \037option\037 est SET, cela renforce les options SECUREOPS et RESTRICTED\n"
            "pour les utilisateur prйsents sur le canal, si elles sont dйjа actives. Indiquez\n"
            "SECUREOPS pour renforcer l'option SECUREOPS, mкme si ce n'est pas dйjа\n"
            "activй. Utilisez RESTRICTED pour renforcer l'option RESTRICTED, йgalement\n"
            "mкme si ce n'est pas dйjа activй.",
        /* LNG_CHAN_HELP_ENFORCE_R_ENABLED */
        "Si \037option\037 est MODES, cela renforce le mode de canal +R s'il est\n"
            "actif. Si +R est spйcifiй pour \037option\037, le mode de canal +R sera\n"
            "йgalement renforcй, et mкme s'il n'est pas dйjа actif. S'il n'est pas actif,\n"
            "les utilisateurs seront bannis pour кtre sыr qu'ils ne reviennent pas.",
        /* LNG_CHAN_HELP_ENFORCE_R_DISABLED */
        "Si \037option\037 est MODES, rien ne sera renforcй, car cela\n"
            "renforcerait des modes que le serveur Irc ne connait pas. Si +R est\n"
            "specifiй pour \037option\037, un йquivalent du mode de canal +R des\n"
            "autres serveurs Irc sera appliquй. Tous les utilisateurs qui sont sur le canal\n"
            "mais non identifiйs avec leur pseudo d'inscrit seront йjectйs et\n"
            "bannis du canal.",
        /* LNG_CHAN_RESPONSE */
        "Renforcй %s"
    };
