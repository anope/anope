/* elemental-ircd IRCD functions
 *
 * (C) 2003-2013 Anope Team
 * Contact us at team@anope.org
 *
 * (C) 2013 Sam Dodrill
 * Contact me at shadow.h511@gmail.com
 *
...
class ProtoElemental : public Module
{
 ...
 public:
	ProtoElemental(const Anope::string &modname, const Anope::string &creator) : Module(modname, creator, PROTOCOL | VENDOR),
		...
		message_bmask("IRCDMessage", "elemental/bmask", "ratbox/bmask"),
		message_join("IRCDMessage", "elemental/join", "ratbox/join"),
		message_nick("IRCDMessage", "elemental/nick", "ratbox/nick"),
		message_pong("IRCDMessage", "elemental/pong", "ratbox/pong"),
		message_sid("IRCDMessage", "elemental/sid", "ratbox/sid"),
		message_sjoin("IRCDMessage", "elemental/sjoin", "ratbox/sjoin"),
		message_tb("IRCDMessage", "elemental/tb", "ratbox/tb"),
		message_tmode("IRCDMessage", "elemental/tmode", "ratbox/tmode"),
