...
static void m_AddLanguages(void)
{
    ...
    char *langtable_fr[] = {
        ...
        /* OINFO_ADD_SUCCESS */
        "Ligne OperInfo ajoutйe au pseudo %s",
        /* OINFO_DEL_SUCCESS */
        "Ligne OperInfo retirйe au pseudo %s",
        /* OCINFO_SYNTAX */
        "Syntaxe: \002OINFO [ADD|DEL] \037canal\037 \037<info>\037\002",
        /* OCINFO_ADD_SUCCESS */
        "Ligne OperInfo ajoutйe au canal %s",
        /* OCINFO_DEL_SUCCESS */
        "Ligne OperInfo retirйe au canal %s",
        /* OINFO_HELP */
        "Syntaxe: \002OINFO [ADD|DEL] \037pseudo\037 \037info\037\002\n"
            ...
            "et peut кtre utilisйe pour 'taguer' les utilisateurs etc....",
        /* OCINFO_HELP */
        ...
        /* OINFO_HELP_CMD */
        "    OINFO         Ajoute / Supprime une ligne OperInfo а un pseudo",
        /* OCINFO_HELP_CMD */
        "    OINFO         Ajoute / Supprime une ligne OperInfo а un canal"
    };
