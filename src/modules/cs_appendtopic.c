...
static void my_add_languages(void)
{
    ...
    char *langtable_fr[] = {
        ...
        /* LNG_CHAN_HELP_APPENDTOPIC */
        "Cette commande permet aux utilisateurs d'ajouter du texte а un sujet\n"
            "du salon. Quand TOPICLOCK est actif, le sujet est mis а jour et\n"
            "le nouveau sujet modifiй est vйrrouillй.",
        /* LNG_APPENDTOPIC_SYNTAX */
