...
static void mAddLanguages(void)
{
    ...
    char *langtable_fr[] = {
        "    TBAN       Bannit l'utilisateur pour une pйriode dйfinie",
        "Syntaxe: \002TBAN \037canal\037 \037pseudo\037 \037durйe\037\002",
        "Bannit un utilisateur d'un canal pour une durйe spйcifiйe.\n"
            "Si le ban est retirй manuellement avant la fin du dйlai, il ne sera PAS remis.",
